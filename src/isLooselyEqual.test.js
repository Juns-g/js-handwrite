...
import { isLooselyEqual } from './isLooselyEqual.js';
...
suite('7.2.14 IsLooselyEqual(x,y)', () => {
	...
	suite('14. Return false.', () => {
		...
		suite(
			'If x is either a String, a Number, a BigInt and y is a Symbol, or if x is a Symbol and y is either a String, a Number, a BigInt, return false.',
			() => {
				it.each([
					{ y: Symbol(''), x: 347 },
					{ y: Symbol(''), x: '' },
